    """
    Json Query Tool 6m62d0c
    =======================
    Developer-friendly CLI that helps you validate projects in seconds.
    ...
    APP_NAME    = "Json Query Tool 6m62d0c"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you validate projects in seconds.")
